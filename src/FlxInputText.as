...
package {
	...
	public class FlxInputText extends FlxText {
		...
		public function FlxInputText(X:Number, Y:Number, Width:uint, Text:String, Color:uint=0x000000, Font:String=null, Size:uint=8, Justification:String=null)
		{
			
			super(X, Y, Width, Text);
			this.setFormat(Font, Size, Color, Justification);
